...
public class WebDriverUtility {
	...
	/**
	 * This method is used for switching from windows
	 * @param driver
	 */
	public void toperformSwitchingWindows(WebDriver driver,String PartialTitle) {
	 ...
	 */
		...
		/**
		 * This method is used to take the screenshot of particular defected element
		 * @param driver
		 * @param imgName
		 * @throws IOException
		 */
